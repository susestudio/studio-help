...
utilize. Depending on your appliance's base template, the default locale
...
would like to provide your appliance's users the most choice, you may
select "Ask on first boot": *YaST* will be used to give your users that
option on first boot.
...
like during different phases of the boot process, and the interface your
...
check "Enable Xen host mode" and SUSE Studio installs the packages
...
crash, when CD-ROM support is enabled. Use this option, to enable CD-ROM
...
groups, four logical volumes (LV 1 through LV 4) have been defined,
